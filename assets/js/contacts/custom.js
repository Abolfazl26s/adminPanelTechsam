function submitContact() {
	if ($("#bookmark-form").valid()) {
		...
		$('#index_var').val(parseInt(index_var)+5);
			...
			var tablist = '	<a class="contact-tab-'+index_var+' nav-link active" id="v-pills-user-tab" data-bs-toggle="pill" onclick="activeDiv('+index_var+')" href="index.htm#v-pills-user" role="tab" aria-controls="v-pills-user" aria-selected="true" data-original-title="" title="">\
			                <div class="media">\
