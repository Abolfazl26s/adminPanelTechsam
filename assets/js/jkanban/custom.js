var kanban1 = new jKanban({
  ...
  boards: [{
      ...
      'item': [{
          'title': `
                               <a class="kanban-box" href="index.htm#"><span class="date">23/7/20</span><span class="badge badge-primary f-right">medium</span>
        ...
        {
          'title': `
                               <a class="kanban-box" href="index.htm#"><span class="date">24/7/20</span><span class="badge badge-danger f-right">Argent</span>
                                <h6>Test Sidebar</h6>
                                <div class="media"><img class="img-20 me-1 rounded-circle" src="../assets/images/user/3.jpg" alt="" data-original-title="" title="">
                                  <div class="media-body">
                                    <p>Themeforest, australia</p>
    ...
    },
    {
      ...
      'item': [{
        ...
        {
          'title': `
                               <a class="kanban-box" href="index.htm#"><span class="date">24/7/20</span><span class="badge badge-success f-right">Low</span>
...
var kanban2 = new jKanban({
  ...
  boards: [{
      ...
      'item': [{
          'title': `
                               <a class="kanban-box" href="index.htm#"><span class="date">24/7/20</span><span class="badge badge-info f-right">medium</span>
                                <h6>Test Sidebar</h6>
                                <div class="media"><img class="img-20 me-1 rounded-circle" src="../assets/images/user/3.jpg" alt="" data-original-title="" title="">
                                  <div class="media-body">
                                    <p>Themeforest, australia</p>
