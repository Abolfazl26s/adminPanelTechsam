...
var HelpDialog = /** @class */ (function () {
    ...
    HelpDialog.prototype.initialize = function () {
        ...
        var body = [
            '<p class="text-center">',
            '<a href="javascript:if(confirm('http://summernote.org/\n\nThis file was not retrieved because it was filtered out by your project settings.\n\nWould you like to open it from the server?'))window.location='http://summernote.org/'" target="_blank">Summernote 0.8.10</a> · ',
            '<a href="javascript:if(confirm('https://github.com/summernote/summernote\n\nThis file was not retrieved because it was filtered out by your project settings.\n\nWould you like to open it from the server?'))window.location='https://github.com/summernote/summernote'" target="_blank">Project</a> · ',
            '<a href="javascript:if(confirm('https://github.com/summernote/summernote/issues\n\nThis file was not retrieved because it was filtered out by your project settings.\n\nWould you like to open it from the server?'))window.location='https://github.com/summernote/summernote/issues'" target="_blank">Issues</a>',
            '</p>'
        ].join('');
        this.$dialog = this.ui.dialog({
