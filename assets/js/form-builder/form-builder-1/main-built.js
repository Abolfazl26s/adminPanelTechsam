...
function generateGuid() {
    ...
    ut.Callbacks = function(e) {
        ...
        if (h.setAttribute("className", "t"), h.innerHTML = "  <link/><table></table><a href='../../../../../a/index.htm'>a</a><input type='checkbox'/>", r = h.getElementsByTagName("*"), i = h.getElementsByTagName("a")[0], !r || !i || !r.length) return {};
        ...
        function(e, t) {
            ...
            C = o.isXML = function(e) {
                ...
                return r !== M && 9 === r.nodeType && r.documentElement ? (M = r, _ = r.documentElement, D = C(r), R.tagNameNoComments = s(function(e) {
                    ...
                    return e.innerHTML = "<a href='index.htm#'></a>", e.firstChild && typeof e.firstChild.getAttribute !== $ && "#" === e.firstChild.getAttribute("href")
                }) ? {} : {
                    href: function(e) {
...
if (!jQuery) throw new Error("Bootstrap requires jQuery"); + function(e) {
    ...
    return '<li><a href="index.htm#----id %-" data-toggle="tab"><%= title %></a></li>\n'
